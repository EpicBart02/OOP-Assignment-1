# Assigment 1
This is the generated project for assignment 1.

After cloning the first step is to build and run from the console using gradle. This should work without errors and verifies that you have a correct installation of java. 
...
You should be prompted to enter your name and then your name should be printed, after that the application terminates.

You may then use the IDE of choice with the appropriate plugins/extensions, e.g. VSCode.
...
1. Checkstyle using the google java standard. There are two changes to the standard: it allows for slighly longer lines, and package names may contain numbers.
